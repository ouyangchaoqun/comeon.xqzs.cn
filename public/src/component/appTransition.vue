...
<style>
    ...
    .addPlayBox  .re_start:before{content: ' '; display: block; width: 0.6rem; height: 0.6rem; background: url('http://oss.xqzs.cn/resources/psy/answer/voice_restart_per.png') no-repeat; background-size: 0.6rem; margin: 0 auto; margin-top: 0.27rem; margin-bottom: 0.17rem;color:#999}
    .addPlayBox .re_start{ text-align: center;color:#56C4FE}
    .addPlayBox .re_start.re_start_per{color:#999;}
    .addPlayBox .re_start.re_start_per:before{ content: ' '; display: block; width: 0.6rem; height: 0.6rem; background: url('http://oss.xqzs.cn/resources/psy/answer/voice_restart_nor.png') no-repeat; background-size: 0.6rem; margin: 0 auto; margin-top: 0.27rem; margin-bottom: 0.17rem;}

    .addPlayBox .send.cant_send:before{ content: ' '; display: block; width: 0.6rem; height: 0.6rem; background: url('http://oss.xqzs.cn/resources/psy/answer/voice_sub_nor.png') no-repeat; background-size: 0.6rem; margin: 0 auto; margin-top: 0.27rem; margin-bottom: 0.17rem;}
    .addPlayBox .send:before{ content: ' '; display: block; width: 0.6rem; height: 0.6rem; background: url('http://oss.xqzs.cn/resources/psy/answer/voice_sub_per.png') no-repeat; background-size: 0.6rem; margin: 0 auto; margin-top: 0.27rem; margin-bottom: 0.17rem;}
