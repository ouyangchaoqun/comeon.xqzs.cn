...
<style>
    ...
    .dotcoin_box .banner.banner_cash_bg{ background: url(../../../images/asker/user_bg_money.png) bottom right #FE7A03 no-repeat; background-size:6.235294117647059rem;background-position-y: 3rem;}
