...
<style>
    ...
    .dotcoin_box .banner.banner_bg{ background: url(http://oss.xqzs.cn/resources/psy/asker/dianCoin.png) bottom right #FE7A03 no-repeat; background-size:6.235294117647059rem; background-position-y: 3rem;}
