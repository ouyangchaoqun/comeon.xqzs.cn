...
<style>
    ...
    .join_box .join_btn{
        width: 100%;
        height:2.5882352941176470588235294117647rem;
        background:rgba(254,122,3,1);
        color:#fff;font-size: 1.0588235294117647058823529411765rem;
        line-height:2.5882352941176470588235294117647; text-align: center;  position: fixed; bottom:0;
    }
    ...
    .service span{ margin-top: 1.8rem; margin-left:0.2rem;display: inline-block; width: 100%; text-align: center;color:rgba(69,75,84,1); font-size: 0.70588235294117647058823529411765rem;}
     ...
     .ewm_box{ position: fixed; top:50%; left:5%; width: 90%;background: #fff; border-radius: 0.8rem; margin-top: -12rem; height: 24rem; z-index: 1000}
     .ewm_box .ewm{width: 18rem;
